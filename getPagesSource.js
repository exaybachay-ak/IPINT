    ...
    */
    ...
    function DOMtoString(document_root) {
        ...
        */
        ...
        ipstoremove = [];
        var loopback = myArray.find(/\b127\.\d{1,3}\.\d{1,3}\.\d{1,3}\b/); 
        var classAprivate = myArray.find(/\b10\.\d{1,3}\.\d{1,3}\.\d{1,3}\b/); 
        var classBprivate = myArray.find(/\b172\.16\.\d{1,3}.\d{1,3}\b/); 
